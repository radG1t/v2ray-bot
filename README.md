...
```
bash <(curl -s https://raw.githubusercontent.com/radG1t/v2ray-bot/main/wizwiz.sh)
```
...
```
bash <(curl -s https://raw.githubusercontent.com/radG1t/v2ray-bot/main/update.sh)
```
